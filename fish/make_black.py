...
root='/home/zzq/oceans17/figures/'
dest='/home/zzq/dest/'
f=open('/home/zzq/kaggle/fish/output')
lines=f.readlines()
...
for i in range(len(lines)):
	...
	for a in range(int(line_[3]),int(line_[5])):
		for b in range(int(line_[2]),int(line_[4])):
			img[a,b,:]=0
	print line_[0]
	# img_region=[255,255,255]
	# img.paste(img,region)
	raw_img_name=dest+'mask_'+line_[0]
