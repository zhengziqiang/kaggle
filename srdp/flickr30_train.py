...
#############################
###### 잡다한 Parameters #####
annotation_path = './data/annotations_flickr30k.pickle'
feat_path = '/home/zzq/srdp_data/feats_flickr30k.npy'
model_path = '/home/zzq/srdp_data/model_30k/'
...
def test(test_feat='/home/zzq/show_attend_and_tell.tensorflow/guitar_player.npy', model_path='/home/zzq/srdp_data/model/model.ckpt-99', maxlen=20):
    annotation_data = pd.read_pickle(annotation_path)
    captions = annotation_data['caption'].values
    wordtoix, ixtoword, bias_init_vector = preProBuildWordVocab(captions)
    n_words = len(wordtoix)
