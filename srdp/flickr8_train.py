...
#############################
###### 잡다한 Parameters #####
annotation_path = '/home/zzq/show_attend_and_tell.tensorflow/data/annotations_flickr8k.pickle'
feat_path = '/home/zzq/srdp_data/feats_flickr8k.npy'
model_path = '/home/zzq/srdp_data/model_8k/'
...
def test(test_feat='/home/zzq/show_attend_and_tell.tensorflow/guitar_player.npy', model_path='/home/zzq/srdp_data/model/model.ckpt-9', maxlen=20):
    annotation_data = pd.read_pickle(annotation_path)
    captions = annotation_data['caption'].values
    wordtoix, ixtoword, bias_init_vector = preProBuildWordVocab(captions)
    n_words = len(wordtoix)
...
def test_tf(test_image_path='/home/zzq/show_attend_and_tell.tensorflow/test/210002.jpg', model_path='/home/zzq/srdp_data/model/model.ckpt-9', maxlen=30):
    ...
    ixtoword = np.load('/home/zzq/show_attend_and_tell.tensorflow/data/ixtoword_demo.npy').tolist()#the ittoword is trained by the photos
