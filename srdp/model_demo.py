...
from tensorflow.python.ops import lstm
...
class Caption_Generator():
    ...
    def __init__(self, dim_image, dim_embed, dim_hidden, batch_size, n_lstm_steps, n_words, bias_init_vector=None):
        ...
        self.lstm = lstm.BasicLSTMCell(dim_hidden)
    ...
    def build_model(self):
        ...
        state = tf.zeros([self.batch_size, self.n_lstm_steps])
...
#annotation_path ='/home/zzq/show_attend_and_tell.tensorflow/data/annotations_demo.pickle' 
annotation_path='/home/zzq/show_attend_and_tell.tensorflow/data/file_demo'
################################################################
...
def train():
   ...
   # feats = np.load(feat_path)
    ...
    np.save('data/ixtoword_demo', ixtoword)
